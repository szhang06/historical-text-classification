...
Original file is located at
    https://colab.research.google.com/drive/1fy3Q6pTcwXH7JPDWj81A05aSrwH_WjIA
"""
...
df = pd.read_csv("/domus/h1/wenwen/research_project_2021/tructed_all_norm.csv")
...
# print(len(df[df.data_type=='val'].Text.values))
...
for epoch in tqdm(range(1, epochs+1)):
    ...
    torch.save(model.state_dict(), f'/domus/h1/wenwen/research_project_2021/model_norm/finetuned_BERT_epoch_{epoch}.model')
...
model.load_state_dict(torch.load('/domus/h1/wenwen/research_project_2021/model_norm/finetuned_BERT_epoch_1.model', map_location=torch.device('cpu')))
